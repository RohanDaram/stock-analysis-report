...
Cloning the Git reposity and and initializing the project using ```uv```
<img alt="Git Clone" src="images/Git Clone.png" />

Project Structure after cloning the repository and running ```uv```
<img alt="Project Structure" src="images/Project Structure.png" />

Adding the dependencies using ```uv add```
<img alt="uv add" src="images/uv add.png" />
